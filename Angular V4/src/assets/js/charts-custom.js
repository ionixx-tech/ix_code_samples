...
$(document).ready(function () {
    ...
    var DOUGHNUTCHARTEXMPLE2  = $('#doughnutChartExample2');
    ...
    var DOUGHNUTCHARTEXMPLE1  = $('#doughnutChartExample1');
    var pieChartExample1 = new Chart(DOUGHNUTCHARTEXMPLE1, {
        type: 'doughnut',
        options: {
            cutoutPercentage: 70,
        },
